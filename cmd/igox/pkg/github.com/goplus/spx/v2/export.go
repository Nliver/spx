...
func init() {
	ixgo.RegisterPackage(&ixgo.Package{
		...
		TypedConsts: map[string]ixgo.TypedConst{
			...
			"DynamicPhysic":        {reflect.TypeOf(q.DynamicPhysic), constant.MakeInt64(int64(q.DynamicPhysic))},
			...
			"KinematicPhysic":      {reflect.TypeOf(q.KinematicPhysic), constant.MakeInt64(int64(q.KinematicPhysic))},
			...
			"NoPhysic":             {reflect.TypeOf(q.NoPhysic), constant.MakeInt64(int64(q.NoPhysic))},
			...
			"StaticPhysic":         {reflect.TypeOf(q.StaticPhysic), constant.MakeInt64(int64(q.StaticPhysic))},
